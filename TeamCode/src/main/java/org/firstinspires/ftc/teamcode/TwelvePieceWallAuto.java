...
@Config
@Autonomous(name = "TwelvePieceWallAuto", group = "Autonomous")
public class TwelvePieceWallAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d initialPose = new Pose2d(-51, -51 * flip, Math.toRadians(225) * flip);
