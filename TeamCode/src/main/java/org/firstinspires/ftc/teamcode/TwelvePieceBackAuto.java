...
@Config
@Autonomous(name = "TwelvePieceBackAuto", group = "Autonomous")
public class TwelvePieceBackAuto extends LinearOpMode {
    ...
    public class Shooter {
        ...
        public class ShooterOnFast implements Action {
            @Override
            public boolean run(@NonNull TelemetryPacket packet) {
                // powers on motor
        ...
        public Action shooterOnFast() {
            return new ShooterOnFast();
        }
    ...
    public void runOpMode() {
        ...
        Pose2d initialPose = new Pose2d(-7, -7 * flip, Math.toRadians(225) * flip);
        ...
        TrajectoryActionBuilder tab2 = drive.actionBuilder(initialPose)
                ...
                .strafeToLinearHeading(new Vector2d(-12, -55 * flip), Math.toRadians(270) * flip, slowVelConstraint)
