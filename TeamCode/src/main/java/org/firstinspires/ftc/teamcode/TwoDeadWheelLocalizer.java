...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -528.4695919011275; // y position of the parallel encoder (in tick units) -637.5641170163647
        public double perpXTicks = -1267.6190056914038; // x position of the perpendicular encoder (in tick units) -1780.8120641500288
    }
