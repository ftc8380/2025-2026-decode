...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = -4.67; // X is the up and down direction
    public static double PARALLEL_Y = 0.945; // Y is the strafe direction

    public static double PERPENDICULAR_X = -4.25;
    public static double PERPENDICULAR_Y = -7.61;
