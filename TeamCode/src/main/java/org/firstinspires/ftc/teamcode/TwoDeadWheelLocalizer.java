...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -637.5641170163647; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1780.8120641500288; // x position of the perpendicular encoder (in tick units)
    }
